...
\title{Gestión de riesgo de liquidez de la Banca peruana en tiempo del
COVID-19 \thanks{Replication files are available on the author's Github
...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={Jhon Figueroa (Universidad Nacional Federico
Villarreal)},
             pdfkeywords = {pandoc, r markdown, knitr},  
            pdftitle={Gestión de riesgo de liquidez de la Banca peruana
